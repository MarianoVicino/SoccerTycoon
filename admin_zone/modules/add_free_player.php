...
$(document).ready(function(){
    $('#add_player_form').submit(function(e){
        ...
        $.ajax({
            ...
            url: 'modules/ajax/add_free_playerAjax.php',
            type: 'POST',
            data: info,
            async: false,
...
<div class="well">
    <div class="len50">
        <h4 class="text-center">AGREGAR JUGADOR GRATIS</h4>
        <div id="msj"></div>
        <form method="POST" action="#" id="add_player_form">
            ...
            <div class="form-group">
                <input type="number" name="number" min="1" class="form-control" placeholder="NUMERO CAMISETA" required>
            </div>
            <div class="form-group">
