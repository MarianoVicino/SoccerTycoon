...
$(document).ready(function(){
    $('#add_shirt_form').submit(function(e){
        e.preventDefault();
        ...
        $.ajax({
            ...
            url: 'modules/ajax/add_shirtAjax.php',
            type: 'POST',
            data: info,
            async: false,
...
<div class="well">
    <div class="len50">
        <h4 class="text-center">AGREGAR CAMISETA</h4>
        <div id="msj">
        ...
        <form method="POST" action="#" id="add_shirt_form" enctype="multipart/form-data">
            <div class="form-group input-group">
                <span class="input-group-addon"><span class="glyphicon glyphicon-picture"></span></span>
                <input type="file" name="shirt" class="form-control" accept="image/png" required>
            </div>    
