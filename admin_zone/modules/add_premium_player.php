...
$(document).ready(function(){
    $('#add_player_form').submit(function(e){
        ...
        $.ajax({
            ...
            url: 'modules/ajax/add_premium_playerAjax.php',
            type: 'POST',
            data: info,
            async: false,
...
<div class="well">
    <div class="len50">
        <h4 class="text-center">AGREGAR JUGADOR PREMIUM</h4>
        <div id="msj"></div>
        <form method="POST" action="#" id="add_player_form" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <input type="number" name="gold" min="0" class="form-control" placeholder="PRECIO EN ORO DEL JUGADOR" required>
            </div>
            <div class="form-group">
                <input type="number" name="stock" min="1" class="form-control" placeholder="NUMERO DE JUGADORES DISPONIBLES" required>
            </div>
            <div class="form-group">
